  ...
  <body class="hold-transition sidebar-mini menusuperior" >
    <div  class="wrapper">
      ...
      <header class="main-header menusuperior">
        ...
        <div id="menu">
 <ul>
  <li><a href="<?php echo e(route('usuarios.ver',['id'=>Auth::user()->id_empleado])); ?>" class="borde" style="padding: 10px"><i class="fa fa-user" 
  ...
  <li><a href="<?php echo e(route('usuarios.edit',['id'=>Auth::user()->id])); ?>" class="borde" style="padding: 10px"><i class="fa fa-key" 
                      aria-hidden="true">&nbsp&nbsp&nbspCambio de contraseña</i></a></li>

  <li> <a href="<?php echo e(url('/logout')); ?>" class="borde" style="padding: 10px"> <i class="fa fa-times-circle" aria-hidden="true">&nbsp&nbsp&nbspCerrar sesion</i></a></li>
 </ul>
</div>
      ...
      <aside class="main-sidebar colormenu" style="font-size: 18px;">
        ...
        <section class="sidebar" >
          ...
          <ul class="sidebar-menu" >
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('empleados','empleado_create')): ?>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu colormenu ">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('empleados')): ?>
                <li><a href="empleados" class="textblack"><i class="fa fa-list textblack"></i>Listado de empleados</a></li>
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('empleado_create')): ?>
            ...
            <div class="col-md-12" >
              <div class="box"  style="width: 100%; height:100%; overflow-x: scroll;">
                <div class="box-header with-border" >
                  <h3 class="box-title"><?php echo $__env->yieldContent("titulo"); ?></h3>
...
</html><?php /**PATH C:\laragon\www\pharmacy-assistant\resources\views/layouts/admin2.blade.php ENDPATH**/ ?>