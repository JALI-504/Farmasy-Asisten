...
<?php $__env->startSection('titulo'); ?><h2 class="text-center">Listado de Inventario</h2><?php $__env->stopSection(); ?>
                ...
                <table class="table table-striped table-hover table-success">
                   ...
                   <!--  <th></th>
                    ...
                    <?php $__currentLoopData = $inventarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inventario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($inventario->codigo_barras); ?></td>
                            <td><?php echo e($inventario->nombre_producto); ?></td>
                            <td><?php echo e($inventario->vencimiento); ?></td>
                            <td><?php echo e($inventario->existencia); ?></td>
                            <td><?php echo e($inventario->precio_compra); ?></td>
                            <td><?php echo e($inventario->precio_venta); ?></td>
                            <td>
                                <a class="btn-border btn-outline-success btn-lg" href="<?php echo e(route('inventario.ver',['id'=>$inventario->id])); ?>">
                                    <i class="fa fa-info"></i>
                                </a>
                            </td>

                           <td>
                               <a class="btn-border btn-outline-warning btn-lg" href="<?php echo e(route('inventario.edit',['id'=>$inventario->id])); ?>">
...
<?php echo $__env->make('layouts.admin2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pharmacy-assistant\resources\views/inventario/inventarioindex.blade.php ENDPATH**/ ?>